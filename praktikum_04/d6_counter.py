...
KNEE_DOWN, KNEE_UP = 100, 160 #ambang squat (deg)
DOWN_R, UP_R = 0.85, 1.00 #ambang push-up (rasio)
SAMPLE_OK = 4 #minimal frame konsisten sebelum
              #ganti state
...
count, state = 0, "up"
debounce = deque(maxlen=6) #gunakan kiri: 11=shoulderL, 15=wristL, 23=hipL
